    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderation_status', models.CharField(choices=[('pending', 'На рассмотрении'), ('approved', 'Одобрено')], default='pending', max_length=10, verbose_name='статус модерации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='авто')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='area',
            name='categories',
            field=models.ManyToManyField(blank=True, to='areas.category', verbose_name='категории'),
        ),
    ]
